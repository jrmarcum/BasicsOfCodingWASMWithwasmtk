(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $d (i32.const 1))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (call $__str_gather (if (result i32) (local.get $d) (then (i32.const 267)) (else (i32.const 271))) (if (result i32) (local.get $d) (then (i32.const 4)) (else (i32.const 5))) (i32.const 132))
  ...
  (data (i32.const 276) "\61\70\70\6c\65")
)