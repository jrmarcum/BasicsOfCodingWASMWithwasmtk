(module
  ...
  (func $indexOf (param $arr i32) (param $v_ptr i32) (param $v_len i32) (result f64)
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (if (i32.eq (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2)))) (i32.gt_s (local.get $v_len) (i32.const 0)))
            (then
            (return (local.get $i))
            )
          )
  ...
  (func $includes (param $arr i32) (param $v_ptr i32) (param $v_len i32) (result i32)
    (return (i32.ge_s (call $indexOf (local.get $arr) (local.get $v_ptr) (local.get $v_len)) (i32.const 0)))
  )
  ...
  (func $some (param $arr i32) (param $pred i32) (result i32)
    ...
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $i) (i32.const 0))))
        (block $cont_1
          (if (call_indirect (type $ftype_i32_r_i32) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2)))) (local.get $pred))
            (then
            (return (i32.const 1))
            )
          )
  ...
  (func $every (param $arr i32) (param $pred i32) (result i32)
    ...
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (i32.const 0))))
        (block $cont_2
          (if (i32.eqz (call_indirect (type $ftype_i32_r_i32) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2)))) (local.get $pred)))
            (then
            (return (i32.const 0))
            )
          )
  ...
  (func $filter (param $arr i32) (param $pred i32) (result i32)
    ...
    (block $break_3
      (loop $loop_3
        (br_if $break_3 (i32.eqz (f64.lt (local.get $i) (i32.const 0))))
        (block $cont_3
          (if (call_indirect (type $ftype_i32_r_i32) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2)))) (local.get $pred))
            (then
            (local.set $result (call $__dynarr_push_string (local.get $result) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2))))))
            )
          )
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
  ...
  (func $mapStr (param $arr i32) (param $fn i32) (result i32)
    ...
    (block $break_4
      (loop $loop_4
        ...
        (block $cont_4
          (local.set $result (call $__dynarr_push_string (local.get $result) (call_indirect (type $ftype_i32_r_i32) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2)))) (local.get $fn))))
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        (br $loop_4)
      )
  ...
  (func $_start (export "_start")
    ...
    (local.set $strs (i32.const 261))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__f64_to_str (call $indexOf (local.get $strs) (i32.const 277) (i32.const 4)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $includes (local.get $strs) (i32.const 281) (i32.const 5)) (then (i32.const 286)) (else (i32.const 290))))
          (i32.store (i32.const 4) (if (result i32) (call $includes (local.get $strs) (i32.const 281) (i32.const 5)) (then (i32.const 4)) (else (i32.const 5))))
          (i32.store (i32.const 8) (i32.const 295))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $some (local.get $strs) (f64.eq (f64.gt (;? (v: string) = ;) (f64.const 0) (;? v[0] ;) (f64.const 0)) (;? "p" ;) (f64.const 0))) (then (i32.const 286)) (else (i32.const 290))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 2)
            (i32.const 128)))
        (i32.store (i32.const 0) (if (result i32) (call $every (local.get $strs) (f64.eq (f64.gt (;? (v: string) = ;) (f64.const 0) (;? v[0] ;) (f64.const 0)) (;? "p" ;) (f64.const 0))) (then (i32.const 286)) (else (i32.const 290))))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $strArrStr (call $filter (local.get $strs) (f64.eq (f64.gt (;? (v: string) = ;) (f64.const 0) (;? v[0] ;) (f64.const 0)) (;? "p" ;) (f64.const 0)))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $strArrStr (call $mapStr (local.get $strs) (;? v: string) => v.toUpperCase( ;) (i32.const 0))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 277) "\70\65\61\72")
  (data (i32.const 281) "\67\72\61\70\65")
