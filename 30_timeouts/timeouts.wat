(module
  ...
  (func $simulateWork (param $ms f64) (param $result_ptr i32) (param $result_len i32) (param $timeoutMs f64) 
    (if (f64.gt (local.get $ms) (local.get $timeoutMs))
      (then
      (return (i32.div_s (;? `timeout ${timeoutMs ;) (i32.const 0) (;? 100}` ;) (i32.const 0)))
      )
    )
  ...
  (func $_start (export "_start")
    ...
    (;; string assignment from complex expression not yet supported: r1 = simulateWork(200, "result 1", 100);)
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (;; string assignment from complex expression not yet supported: r2 = simulateWork(200, "result 2", 300);)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
