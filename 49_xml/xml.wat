(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 493))
  ...
  (func $buildPlantXml (param $plant i32) (param $indent_ptr i32) (param $indent_len i32) 
    ...
    (local.set $s_ptr (local.get $indent_ptr))
      ...
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 271) (i32.const 3))
      (local.set $s_len)
      (local.set $s_ptr)
    (local.set $s_ptr (local.get $s_ptr))
      ...
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 274) (i32.const 8))
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.load offset=8 (local.get $plant)) (i32.load offset=12 (local.get $plant)))
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 282) (i32.const 8))
      (local.set $s_len)
      (local.set $s_ptr)
    ...
    (block $break_0
      ...
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 290) (i32.const 10))
      (local.set $s_len)
      (local.set $s_ptr)
      (local.set $__tmpl_num_ptr (call $__malloc (i32.const 32)))
      ...
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 300) (i32.const 10))
      (local.set $s_len)
      (local.set $s_ptr)
        )
    ...
    (local.set $s_ptr (local.get $s_ptr))
      ...
      (local.set $s_len)
      (local.set $s_ptr)
      (call $__str_concat (local.get $s_ptr) (local.get $s_len) (i32.const 310) (i32.const 8))
      (local.set $s_len)
      (local.set $s_ptr)
  ...
  (func $_start (export "_start")
    ...
    (local $__tmpl_num_ptr i32)
    (local $__tmpl_num_len i32)
    (local.set $coffee (i32.const 318))
    (local.set $tomato (i32.const 344))
    (call $buildPlantXml (local.get $coffee) (i32.const 370) (i32.const 1))
(local.set $coffeeXml_ptr (global.get $__str_ret_ptr))
      (local.set $coffeeXml_len (global.get $__str_ret_len))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 371))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__f64_to_str (f64.load (i32.add (i32.const 318) (i32.const 0))) (i32.const 141))))
          ...
          (call $__str_gather (i32.load offset=8 (i32.const 318)) (i32.load offset=12 (i32.const 318)) (i32.add (i32.const 132) (i32.load (i32.const 4))))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.load offset=12 (i32.const 318))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 44))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 32))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $nestingXml_ptr (i32.const 410))
      (local.set $nestingXml_len (i32.const 36))
      (call $buildPlantXml (local.get $coffee) (i32.const 446) (i32.const 7))
      ...
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (i32.const 453) (i32.const 1))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
      (call $buildPlantXml (local.get $tomato) (i32.const 446) (i32.const 7))
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (global.get $__str_ret_ptr) (global.get $__str_ret_len))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
      (call $__str_concat (local.get $nestingXml_ptr) (local.get $nestingXml_len) (i32.const 454) (i32.const 39))
      (local.set $nestingXml_len)
      (local.set $nestingXml_ptr)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (data (i32.const 271) "\22\3e\0a")
  (data (i32.const 274) "\20\20\3c\6e\61\6d\65\3e")
  (data (i32.const 282) "\3c\2f\6e\61\6d\65\3e\0a")
  (data (i32.const 290) "\20\20\3c\6f\72\69\67\69\6e\3e")
  (data (i32.const 300) "\3c\2f\6f\72\69\67\69\6e\3e\0a")
  (data (i32.const 310) "\3c\2f\70\6c\61\6e\74\3e")
  (data (i32.const 338) "\43\6f\66\66\65\65")
  (data (i32.const 364) "\54\6f\6d\61\74\6f")
  (data (i32.const 370) "\20")
  (data (i32.const 371) "\3c\3f\78\6d\6c\20\76\65\72\73\69\6f\6e\3d\22\31\2e\30\22\20\65\6e\63\6f\64\69\6e\67\3d\22\55\54\46\2d\38\22\3f\3e\0a")
  (data (i32.const 410) "\20\3c\6e\65\73\74\69\6e\67\3e\0a\20\20\20\3c\70\61\72\65\6e\74\3e\0a\20\20\20\20\20\3c\63\68\69\6c\64\3e\0a")
  (data (i32.const 446) "\20\20\20\20\20\20\20")
  (data (i32.const 453) "\0a")
  (data (i32.const 454) "\0a\20\20\20\20\20\3c\2f\63\68\69\6c\64\3e\0a\20\20\20\3c\2f\70\61\72\65\6e\74\3e\0a\20\3c\2f\6e\65\73\74\69\6e\67\3e")
  (data (i32.const 318) "\00\00\00\00\00\00\3b\40\52\01\00\00\06\00\00\00\00\00\00\00")
  (data (i32.const 344) "\00\00\00\00\00\40\54\40\6c\01\00\00\06\00\00\00\00\00\00\00")
)