(module
  ...
  (func $count (param $s_ptr i32) (param $s_len i32) (param $sub_ptr i32) (param $sub_len i32) (result f64)
    ...
    (if (i32.eq (local.get $sub_len) (i32.const 0))
      (then
      (return (f64.add (local.get $s_len) (f64.const 1)))
      )
    )
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (local.set $idx (call $__str_indexof (local.get $s_ptr) (local.get $s_len) (i32.const 0) (i32.const 0)))
          ...
          (local.set $pos (f64.add (local.get $idx) (local.get $sub_len)))
        )
        (br $loop_0)
      )
    )
  ...
  (func $strIndex (param $s_ptr i32) (param $s_len i32) (param $sub_ptr i32) (param $sub_len i32) (result f64)
    (local $__iface_tmp i32)
    (return (call $__str_indexof (local.get $s_ptr) (local.get $s_len) (local.get $sub_ptr) (local.get $sub_len)))
  )
      ...
      (loop $loop_1
        ...
        (block $cont_1
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
            (local.set $r (i32.add (local.get $r) (i32.gt_s (local.get $sep_len) (i32.const 0))))
            )
          )
          (local.set $r (i32.add (local.get $r) (i32.load (i32.add (local.get $arr) (i32.shl (local.get $i) (i32.const 2))))))
        )
    ...
    (block $break_2
      (loop $loop_2
        ...
        (block $cont_2
          ...
          (if (f64.lt (local.get $idx) (f64.const 0))
            (then
            (local.set $r (i32.add (local.get $r) (;? s.slice(pos) ;) (i32.const 0)))
            (br $break_2)
            )
          )
          (local.set $r (i32.add (local.get $r) (i32.add (;? s.slice(pos, idx) ;) (i32.const 0) (i32.gt_s (local.get $nw_len) (i32.const 0)))))
          (local.set $pos (f64.add (local.get $idx) (local.get $old_len)))
        )
        (br $loop_2)
      )
    )
  ...
  (func $replace (param $s_ptr i32) (param $s_len i32) (param $old_ptr i32) (param $old_len i32) (param $nw_ptr i32) (param $nw_len i32) 
    (local $idx f64)
    (local $__iface_tmp i32)
    (local.set $idx (call $__str_indexof (local.get $s_ptr) (local.get $s_len) (local.get $old_ptr) (local.get $old_len)))
    (if (f64.lt (local.get $idx) (f64.const 0))
      (then
      (return (local.get $s_ptr))
      )
    )
    (return (i32.add (i32.add (;? s.slice(0, idx) ;) (i32.const 0) (local.get $nw_ptr)) (;? s.slice(idx + old.length) ;) (i32.const 0)))
  )
    ...
    (block $break_3
      (loop $loop_3
        ...
        (block $cont_3
          ...
          (local.set $pos (f64.add (local.get $idx) (local.get $sep_len)))
        )
        (br $loop_3)
      )
    )
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $join (;? ["a", "b"] ;) (i32.const 0) (i32.const 319) (i32.const 1)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $repeat (i32.const 320) (i32.const 1) (f64.const 5)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $replaceAll (i32.const 321) (i32.const 3) (i32.const 324) (i32.const 1) (i32.const 325) (i32.const 1)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $replace (i32.const 321) (i32.const 3) (i32.const 324) (i32.const 1) (i32.const 325) (i32.const 1)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 142) (i32.const 32))
          (i32.store8 (i32.const 143) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__i32_to_str (call $strArrStr (call $split (i32.const 326) (i32.const 9) (i32.const 319) (i32.const 1))) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 319) "\2d")
  (data (i32.const 320) "\61")
  (data (i32.const 321) "\66\6f\6f")
  (data (i32.const 324) "\6f")
  (data (i32.const 325) "\30")
  (data (i32.const 326) "\61\2d\62\2d\63\2d\64\2d\65")
)