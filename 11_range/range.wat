(module
  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $idx) (i32.const 3))))
        (block $cont_0
          (global.set $sum (f64.add (global.get $sum) (f64.load (i32.add (i32.const 260) (i32.shl (local.get $idx) (i32.const 3))))))
        )
    ...
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $idx) (i32.const 3))))
        (block $cont_1
          (if (i32.eq (f64.load (i32.add (i32.const 260) (i32.shl (local.get $idx) (i32.const 3)))) (i32.const 3))
            (then
                (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
    ...
    (local.set $kvKeys (i32.const 284))
    (local.set $kvVals (i32.const 292))
    (local.set $i (f64.const 0))
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (i32.const 2))))
        (block $cont_2
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store (i32.const 4) (i32.add (i32.const 0) (call $__i32_to_str (i32.load (i32.add (i32.const 284) (i32.shl (local.get $i) (i32.const 2)))) (i32.const 132))))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.const 292) (i32.shl (local.get $i) (i32.const 2)))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_3
      (loop $loop_3
        (br_if $break_3 (i32.eqz (f64.lt (local.get $i) (i32.const 2))))
        (block $cont_3
              (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          ...
          (i32.store8 (i32.const 135) (i32.const 58))
          (i32.store8 (i32.const 136) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 5) (call $__i32_to_str (i32.load (i32.add (i32.const 284) (i32.shl (local.get $i) (i32.const 2)))) (i32.const 137))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 300) "\30\20\31\30\33\0a")
  (data (i32.const 306) "\31\20\31\31\31\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40")
  (data (i32.const 284) "\00\00\00\00\00\00\00\00")
  (data (i32.const 292) "\00\00\00\00\00\00\00\00")
)