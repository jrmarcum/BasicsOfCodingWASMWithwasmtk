(module
  ...
  (func $baseDescribe (param $b i32) 
    (return (;? `base with num=${b.num}` ;) (i32.const 0))
  )
  ...
  (func $containerDescribe (param $co i32) 
    (return (call $baseDescribe (i32.load (i32.add (local.get $co) (i32.const 0)))))
  )
  (func $_start (export "_start")
    (local $co i32)
    (local $__iface_tmp i32)
    (local.set $co (call $newContainer (f64.const 1) (i32.const 260) (i32.const 9)))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 58))
          (i32.store8 (i32.const 141) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 10) (call $__i32_to_str (call $containerDescribe (local.get $co)) (i32.const 142))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 260) "\73\6f\6d\65\20\6e\61\6d\65")
)