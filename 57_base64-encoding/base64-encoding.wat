(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 408))
  ...
  (func $base64Encode (param $data_ptr i32) (param $data_len i32) (param $chars_ptr i32) (param $chars_len i32) (param $pad i32) 
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (local.get $data_len)))))
        (block $cont_0
          (local.set $b0 (f64.convert_i32_s (call $__str_char_code_at (local.get $data_ptr) (local.get $data_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0))))))
          (local.set $b1 (if (result f64) (f64.lt (local.get $i) (f64.convert_i32_s (local.get $data_len))) (then (f64.convert_i32_s (call $__str_char_code_at (local.get $data_ptr) (local.get $data_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0)))))) (else (f64.const 0))))
          (local.set $b2 (if (result f64) (f64.lt (local.get $i) (f64.convert_i32_s (local.get $data_len))) (then (f64.convert_i32_s (call $__str_char_code_at (local.get $data_ptr) (local.get $data_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0)))))) (else (f64.const 0))))
    ...
    (if (local.get $pad)
      (then
      (local.set $rem (f64.sub (f64.convert_i32_s (local.get $data_len)) (f64.mul (f64.trunc (f64.div (f64.convert_i32_s (local.get $data_len)) (f64.const 3))) (f64.const 3))))
      (if (f64.eq (local.get $rem) (f64.const 1))
        (then
      ...
      (local.set $result_ptr (local.get $__str_op_ptr))
      (local.set $result_len (local.get $__str_op_len))
  ...
  (func $base64Decode (param $encoded_ptr i32) (param $encoded_len i32) (param $chars_ptr i32) (param $chars_len i32) 
    ...
    (local $__str_op_ptr i32)
    (local $__str_op_len i32)
    (local.set $lookup (call $__malloc (i32.const 72)))
      (i32.store (local.get $lookup) (i32.const 0))
      (i32.store offset=4 (local.get $lookup) (i32.const 8))
    (local.set $i (f64.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $i) (f64.const 256))))
        (block $cont_1
          (local.set $lookup (call $__dynarr_push_f64 (local.get $lookup) (f64.const -1)))
        )
    ...
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (local.get $chars_len)))))
        (block $cont_2
          (f64.store (i32.add (i32.add (local.get $lookup) (i32.const 8)) (i32.shl (call $__str_char_code_at (local.get $chars_ptr) (local.get $chars_len) (i32.trunc_f64_s (local.get $i))) (i32.const 3))) (local.get $i))
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        (br $loop_2)
      )
    ...
    (local.set $result_ptr (i32.const 406))
      (local.set $result_len (i32.const 0))
    (local.set $i (f64.const 0))
    (call $__str_replace (local.get $encoded_ptr) (local.get $encoded_len) (i32.const 0) (i32.const 0) (i32.const 406) (i32.const 0))
      (local.set $cleaned_len)
      (local.set $cleaned_ptr)
    (block $break_3
      (loop $loop_3
        (br_if $break_3 (i32.eqz (f64.lt (local.get $i) (f64.convert_i32_s (local.get $cleaned_len)))))
        (block $cont_3
          (local.set $c0 (f64.load (i32.add (i32.add (local.get $lookup) (i32.const 8)) (i32.shl (call $__str_char_code_at (local.get $cleaned_ptr) (local.get $cleaned_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0)))) (i32.const 3)))))
          (local.set $c1 (if (result f64) (f64.lt (local.get $i) (f64.convert_i32_s (local.get $cleaned_len))) (then (f64.load (i32.add (i32.add (local.get $lookup) (i32.const 8)) (i32.shl (call $__str_char_code_at (local.get $cleaned_ptr) (local.get $cleaned_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0)))) (i32.const 3))))) (else (f64.const 0))))
          (local.set $c2 (if (result f64) (f64.lt (local.get $i) (f64.convert_i32_s (local.get $cleaned_len))) (then (f64.load (i32.add (i32.add (local.get $lookup) (i32.const 8)) (i32.shl (call $__str_char_code_at (local.get $cleaned_ptr) (local.get $cleaned_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0)))) (i32.const 3))))) (else (f64.const 0))))
          (local.set $c3 (if (result f64) (f64.lt (local.get $i) (f64.convert_i32_s (local.get $cleaned_len))) (then (f64.load (i32.add (i32.add (local.get $lookup) (i32.const 8)) (i32.shl (call $__str_char_code_at (local.get $cleaned_ptr) (local.get $cleaned_len) (i32.trunc_f64_s (f64.add (f64.add (local.get $i) (;?  ;) (f64.const 0)) (;?  ;) (f64.const 0)))) (i32.const 3))))) (else (f64.const 0))))
          (local.set $result_ptr (local.get $result_ptr))
      (local.set $result_len (local.get $result_len))
      (local.set $__str_op_ptr (call $__malloc (i32.const 1)))
      (i32.store8 (local.get $__str_op_ptr) (i32.and (i32.or (i32.shl (i32.trunc_f64_s (local.get $c0)) (i32.const 2)) (i32.shr_s (i32.trunc_f64_s (local.get $c1)) (i32.const 4))) (i32.const 255)))
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (local.get $__str_op_ptr) (i32.const 1))
      (local.set $result_len)
      (local.set $result_ptr)
          (if (f64.gt (local.get $i) (f64.const 2))
            (then
            (local.set $result_ptr (local.get $result_ptr))
      (local.set $result_len (local.get $result_len))
      (local.set $__str_op_ptr (call $__malloc (i32.const 1)))
      (i32.store8 (local.get $__str_op_ptr) (i32.and (i32.or (i32.shl (i32.trunc_f64_s (local.get $c1)) (i32.const 4)) (i32.shr_s (i32.trunc_f64_s (local.get $c2)) (i32.const 2))) (i32.const 255)))
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (local.get $__str_op_ptr) (i32.const 1))
      (local.set $result_len)
      (local.set $result_ptr)
            )
          )
          (if (f64.gt (local.get $i) (f64.const 3))
            (then
            (local.set $result_ptr (local.get $result_ptr))
      (local.set $result_len (local.get $result_len))
      (local.set $__str_op_ptr (call $__malloc (i32.const 1)))
      (i32.store8 (local.get $__str_op_ptr) (i32.and (i32.or (i32.shl (i32.trunc_f64_s (local.get $c2)) (i32.const 6)) (i32.trunc_f64_s (local.get $c3))) (i32.const 255)))
      (call $__str_concat (local.get $result_ptr) (local.get $result_len) (local.get $__str_op_ptr) (i32.const 1))
      (local.set $result_len)
      (local.set $result_ptr)
            )
