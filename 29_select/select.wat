(module
  ...
  (func $_start (export "_start")
    ...
    (;; string assignment from complex expression not yet supported: c1 = makeMessage("one");)
    (;; string assignment from complex expression not yet supported: c2 = makeMessage("two");)
