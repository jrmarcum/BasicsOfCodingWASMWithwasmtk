(module
  ...
  (func $headersHandler (param $hdrs i32) 
    ...
    (local $i f64)
    (local.set $result_ptr (i32.const 260))
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          (local.set $result (i32.add (local.get $result) (;? `${hdrs[i].name}: ${hdrs[i].value}\n` ;) (i32.const 0)))
        )
  ...
  (func $_start (export "_start")
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $hello) (i32.const 132)))
