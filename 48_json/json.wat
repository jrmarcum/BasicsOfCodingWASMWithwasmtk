(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 478))
  ...
  (func $jsonBool (param $v i32) 
    (return (if (result string) (local.get $v) (then (;? "true" ;) (i32.const 0)) (else (;? "false" ;) (i32.const 0))))
  )

  (func $jsonNum (param $v f64) 
    (local $s_ptr i32)
    (local $s_len i32)
    (;; string assignment from complex expression not yet supported: s = `${v}`;)
    (return (local.get $s_ptr))
  )

  (func $jsonStr (param $v_ptr i32) (param $v_len i32) 
    (return (;? `"${v}"` ;) (i32.const 0))
  )
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          ...
          (local.set $s (i32.add (local.get $s) (call $jsonStr (i32.const 0) (i32.const 0))))
        )
  ...
  (func $_start (export "_start")
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $jsonBool (i32.const 1)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $jsonNum (f64.const 1)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $jsonNum (f64.const 2.34)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $jsonStr (i32.const 273) (i32.const 6)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $slcD (i32.const 261))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $jsonStrArr (local.get $slcD)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 348))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $byt_ptr (i32.const 393))
      (local.set $byt_len (i32.const 29))
        (i32.store (i32.const 0) (i32.const 422))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 447))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 452))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 454))
  ...
  (data (i32.const 273) "\76\65\63\74\6f\72")
  (data (i32.const 279) "\7b\22\61\70\70\6c\65\22\3a\35\2c\22\6c\65\74\74\75\63\65\22\3a\37\7d\0a")
  (data (i32.const 303) "\7b\22\50\61\67\65\22\3a\31\2c\22\46\72\75\69\74\73\22\3a\5b\22\61\70\70\6c\65\22\2c\22\70\65\61\63\68\22\2c\22\70\65\61\72\22\5d\7d\0a")
  (data (i32.const 348) "\7b\22\70\61\67\65\22\3a\31\2c\22\66\72\75\69\74\73\22\3a\5b\22\61\70\70\6c\65\22\2c\22\70\65\61\63\68\22\2c\22\70\65\61\72\22\5d\7d\0a")
  (data (i32.const 393) "\7b\22\6e\75\6d\22\3a\36\2e\31\33\2c\22\73\74\72\73\22\3a\5b\22\61\22\2c\22\62\22\5d\7d")
  (data (i32.const 422) "\7b\6e\75\6d\3a\20\36\2e\31\33\2c\20\73\74\72\73\3a\20\5b\61\20\62\5d\7d\0a")
  (data (i32.const 447) "\36\2e\31\33\0a")
  (data (i32.const 452) "\61\0a")
  (data (i32.const 454) "\7b\31\20\5b\61\70\70\6c\65\20\70\65\61\63\68\5d\7d\0a")
  (data (i32.const 472) "\61\70\70\6c\65\0a")
