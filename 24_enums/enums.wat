          ...
          (block $case_0_2
            (block $case_0_1
              (block $case_0_0
                ...
                (return (;? "idle" ;) (i32.const 0))
            )
              (return (;? "connected" ;) (i32.const 0))
          )
            (return (;? "error" ;) (i32.const 0))
        )
          (return (;? "retrying" ;) (i32.const 0))
      )
        (return (;? "unknown" ;) (i32.const 0))
    )
  )
  ...
  (func $_start (export "_start")
    ...
    (local.set $ns (call $transition (i32.const 0)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $stateName (local.get $ns)) (i32.const 132)))
    ...
    (local.set $ns2 (call $transition (local.get $ns)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $stateName (local.get $ns2)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
