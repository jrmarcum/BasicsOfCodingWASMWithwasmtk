(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $fooName_ptr (i32.const 269))
      (local.set $fooName_len (i32.const 3))
    (local.set $fooTail (i32.const 261))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (call $__str_gather (if (result i32) (local.get $fooEnable) (then (i32.const 289)) (else (i32.const 293))) (if (result i32) (local.get $fooEnable) (then (i32.const 4)) (else (i32.const 5))) (i32.const 142))
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 58))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__i32_to_str (call $strArrStr (local.get $fooTail)) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 269) "\6a\6f\65")
  (data (i32.const 272) "\73\75\62\63\6f\6d\6d\61\6e\64\20\27\66\6f\6f\27\0a")
  (data (i32.const 289) "\74\72\75\65")
  (data (i32.const 293) "\66\61\6c\73\65")
  (data (i32.const 261) "\00\00\00\00\00\00\00\00")
)