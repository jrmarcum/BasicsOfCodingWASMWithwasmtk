(module
  ...
  (func $sortStrings (param $arr i32) 
    ...
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (f64.sub (i32.const 0) (f64.const 1)))))
        (block $cont_0
          (local.set $j (f64.const 0))
          (block $break_1
            (loop $loop_1
              (br_if $break_1 (i32.eqz (f64.lt (local.get $j) (f64.sub (f64.sub (i32.const 0) (f64.const 1)) (local.get $i)))))
              (block $cont_1
                (if (i32.gt_s (i32.load (i32.add (local.get $arr) (i32.shl (local.get $j) (i32.const 2)))) (i32.load (i32.add (local.get $arr) (i32.shl (f64.add (local.get $j) (f64.const 1)) (i32.const 2)))))
                  (then
                  (;; string assignment from complex expression not yet supported: tmp = arr[j];)
                  (i32.store (i32.add (local.get $arr) (i32.shl (local.get $j) (i32.const 2))) (i32.load (i32.add (local.get $arr) (i32.shl (f64.add (local.get $j) (f64.const 1)) (i32.const 2)))))
                  (i32.store (i32.add (local.get $arr) (i32.shl (f64.add (local.get $j) (f64.const 1)) (i32.const 2))) (local.get $tmp_ptr))
                  )
                )
              )
  ...
  (func $sortNums (param $arr i32) 
    ...
    (block $break_2
      (loop $loop_2
        (br_if $break_2 (i32.eqz (f64.lt (local.get $i) (f64.sub (i32.const 0) (f64.const 1)))))
        (block $cont_2
          (local.set $j (f64.const 0))
          (block $break_3
            (loop $loop_3
              (br_if $break_3 (i32.eqz (f64.lt (local.get $j) (f64.sub (f64.sub (i32.const 0) (f64.const 1)) (local.get $i)))))
              (block $cont_3
                (if (i32.gt_s (f64.load (i32.add (local.get $arr) (i32.shl (local.get $j) (i32.const 3)))) (f64.load (i32.add (local.get $arr) (i32.shl (f64.add (local.get $j) (f64.const 1)) (i32.const 3)))))
                  (then
                  (local.set $tmp (f64.load (i32.add (local.get $arr) (i32.shl (local.get $j) (i32.const 3)))))
                  (f64.store (i32.add (local.get $arr) (i32.shl (local.get $j) (i32.const 3))) (f64.load (i32.add (local.get $arr) (i32.shl (f64.add (local.get $j) (f64.const 1)) (i32.const 3)))))
                  (f64.store (i32.add (local.get $arr) (i32.shl (f64.add (local.get $j) (f64.const 1)) (i32.const 3))) (local.get $tmp))
                  )
                )
              )
              (local.set $j (f64.add (local.get $j) (f64.const 1)))
  ...
  (func $strArrStr (param $arr i32) 
    ...
    (block $break_4
      (loop $loop_4
        (br_if $break_4 (i32.eqz (f64.lt (local.get $i) (i32.const 0))))
        (block $cont_4
  ...
  (func $numArrStr (param $arr i32) 
    ...
    (block $break_5
      (loop $loop_5
        (br_if $break_5 (i32.eqz (f64.lt (local.get $i) (i32.const 0))))
        (block $cont_5
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
            (local.set $s (i32.add (local.get $s) (;? " " ;) (i32.const 0)))
          ...
          (local.set $s (i32.add (local.get $s) (;? `${arr[i]}` ;) (i32.const 0)))
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        (br $loop_5)
      )
  ...
  (func $_start (export "_start")
    ...
    (call $sortStrings (local.get $strs))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (call $strArrStr (local.get $strs)) (i32.const 141))))
    ...
    (call $sortNums (local.get $ints))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 140) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 9) (call $__i32_to_str (call $numArrStr (local.get $ints)) (i32.const 141))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
    ...
    (block $break_6
      (loop $loop_6
        (br_if $break_6 (i32.eqz (f64.lt (local.get $i) (i32.const 3))))
        (block $cont_6
          (if (i32.gt_s (f64.load (i32.add (i32.const 273) (i32.shl (f64.sub (local.get $i) (f64.const 1)) (i32.const 3)))) (f64.load (i32.add (i32.const 273) (i32.shl (local.get $i) (i32.const 3)))))
            (then
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store8 (i32.const 140) (i32.const 32))
          (call $__str_gather (if (result i32) (local.get $isSorted) (then (i32.const 297)) (else (i32.const 301))) (if (result i32) (local.get $isSorted) (then (i32.const 4)) (else (i32.const 5))) (i32.const 141))
  ...
  (data (i32.const 297) "\74\72\75\65")
  (data (i32.const 301) "\66\61\6c\73\65")
  (data (i32.const 261) "\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 273) "\00\00\00\00\00\00\1c\40\00\00\00\00\00\00\00\40\00\00\00\00\00\00\10\40")
)