(module
  ...
  (func $fmtPerson (param $p i32) 
    (return (;? `{${p.name} ${p.age}}` ;) (i32.const 0))
  )
  (func $_start (export "_start")
    ...
    (local $__iface_tmp i32)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $fmtPerson (call $newPerson (i32.const 268) (i32.const 3) (f64.const 20))) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $fmtPerson (call $newPerson (i32.const 271) (i32.const 5) (f64.const 30))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $fmtPerson (;? { name: "Fred", age: 0 } ;) (i32.const 0)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $fmtPerson (call $newPersonWithAge (i32.const 276) (i32.const 3))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $fmtPerson (call $newPersonWithAge (i32.const 279) (i32.const 3))) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $s (call $newPerson (i32.const 282) (i32.const 4) (f64.const 50)))
        (i32.store (i32.const 0) (i32.const 132))
    ...
    (f64.store (i32.add (local.get $s) (i32.const 8)) (f64.const 51))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $dog (i32.const 260))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 123))
          (i32.store (i32.const 4) (i32.add (i32.const 1) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 0))) (i32.const 133))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 4))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
  ...
  (data (i32.const 268) "\42\6f\62")
  (data (i32.const 271) "\41\6c\69\63\65")
  (data (i32.const 276) "\41\6e\6e")
  (data (i32.const 279) "\4a\6f\6e")
  (data (i32.const 282) "\53\65\61\6e")
