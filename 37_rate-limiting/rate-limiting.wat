(module
  ...
  (func $_start (export "_start")
    ...
    (block $break_0
      (loop $loop_0
        ...
        (block $cont_0
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (f64.load (i32.add (i32.const 260) (i32.shl (local.get $i) (i32.const 3)))) (i32.const 140))))
    ...
    (local.set $burstyRequests (i32.const 300))
    (local.set $i (f64.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $i) (i32.const 5))))
        (block $cont_1
          (if (i32.gt_s (global.get $tokens) (i32.const 0))
            (then
            (local.set $tokens (i32.sub (local.get $tokens) (i32.const 1)))
                (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 114))
          (i32.store8 (i32.const 133) (i32.const 101))
          ...
          (i32.store8 (i32.const 138) (i32.const 116))
          (i32.store8 (i32.const 139) (i32.const 32))
          (i32.store (i32.const 4) (i32.add (i32.const 8) (call $__f64_to_str (f64.load (i32.add (i32.const 300) (i32.shl (local.get $i) (i32.const 3)))) (i32.const 140))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 50))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 48))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 48))
  ...
  (data (i32.const 300) "\00\00\00\00\00\00\f0\3f\00\00\00\00\00\00\00\40\00\00\00\00\00\00\08\40\00\00\00\00\00\00\10\40\00\00\00\00\00\00\14\40")
)