(module
  ...
  (func $buildPlantXml (param $plant i32) (param $indent_ptr i32) (param $indent_len i32) 
    ...
    (local $s_len i32)
    (local $i f64)
    (;; string assignment from complex expression not yet supported: s = `${indent}<plant id="${plant.id}">\n`;)
    (local.set $s (i32.add (local.get $s) (i32.lt_s (i32.lt_s (;? `${indent} ;) (i32.const 0) (i32.gt_s (;? name ;) (i32.const 0) (;? ${plant.name} ;) (i32.const 0))) (i32.gt_s (i32.div_s (;?  ;) (i32.const 0) (;? name ;) (i32.const 0)) (;? \n` ;) (i32.const 0)))))
    (local.set $i (f64.const 0))
    (block $break_0
      (loop $loop_0
        (br_if $break_0 (i32.eqz (f64.lt (local.get $i) (;? plant.origin.length ;) (f64.const 0))))
        (block $cont_0
          (local.set $s (i32.add (local.get $s) (i32.lt_s (i32.lt_s (;? `${indent} ;) (i32.const 0) (i32.gt_s (;? origin ;) (i32.const 0) (;? ${plant.origin[i]} ;) (i32.const 0))) (i32.gt_s (i32.div_s (;?  ;) (i32.const 0) (;? origin ;) (i32.const 0)) (;? \n` ;) (i32.const 0)))))
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        (br $loop_0)
      )
    )
    (local.set $s (i32.add (local.get $s) (i32.lt_s (;? `${indent} ;) (i32.const 0) (i32.gt_s (i32.div_s (;?  ;) (i32.const 0) (local.get $plant)) (;? ` ;) (i32.const 0)))))
  ...
  (func $_start (export "_start")
    ...
    (local.set $tomato (i32.const 276))
    (;; string assignment from complex expression not yet supported: coffeeXml = buildPlantXml(coffee, " ");)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__i32_to_str (i32.load (i32.add (i32.const 260) (i32.const 8))) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 44))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 32))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (;; string assignment from complex expression not yet supported: nestingXml = ` <nesting>\n   <parent>\n     <child>\n${buildPlantXml(coffee, "       ")}\n${buildPlantXml(tomato, "       ")}\n     </child>\n   </parent>\n </nesting>`;)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
  ...
  (data (i32.const 292) "\3c\3f\78\6d\6c\20\76\65\72\73\69\6f\6e\3d\22\31\2e\30\22\20\65\6e\63\6f\64\69\6e\67\3d\22\55\54\46\2d\38\22\3f\3e\0a")
  (data (i32.const 260) "\00\00\00\00\00\00\3b\40\00\00\00\00\00\00\00\00")
  (data (i32.const 276) "\00\00\00\00\00\40\54\40\00\00\00\00\00\00\00\00")
)