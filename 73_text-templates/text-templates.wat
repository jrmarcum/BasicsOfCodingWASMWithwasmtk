(module
  ...
  (global $__heap_ptr (mut i32) (i32.const 369))
  ...
  (func $renderDot (param $tmpl_ptr i32) (param $tmpl_len i32) (param $val_ptr i32) (param $val_len i32) 
    ...
    (return (;? tmpl.replace("{{.}}", val) ;) (i32.const 0))
  )
  ...
  (func $renderField (param $tmpl_ptr i32) (param $tmpl_len i32) (param $field_ptr i32) (param $field_len i32) (param $val_ptr i32) (param $val_len i32) 
    ...
    (local $__iface_tmp i32)
    (;; string assignment from complex expression not yet supported: needle = `{{.${field}}}`;)
    (return (;? tmpl.replace(needle, val) ;) (i32.const 0))
  )
      ...
      (loop $loop_0
        ...
        (block $cont_0
          (if (f64.gt (local.get $i) (f64.const 0))
            (then
            (local.set $s (i32.add (local.get $s) (i32.gt_s (local.get $sep_len) (i32.const 0))))
            )
          )
  ...
  (func $_start (export "_start")
    ...
    (local $i f64)
    (local $__iface_tmp i32)
    (local.set $t1_ptr (i32.const 276))
      (local.set $t1_len (i32.const 12))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 288) (i32.const 9)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 297) (i32.const 1)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $renderDot (local.get $t1_ptr) (local.get $t1_len) (i32.const 298) (i32.const 16)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $t2_ptr (i32.const 314))
      (local.set $t2_len (i32.const 15))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $renderField (local.get $t2_ptr) (local.get $t2_len) (i32.const 329) (i32.const 4) (i32.const 333) (i32.const 8)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $renderField (local.get $t2_ptr) (local.get $t2_len) (i32.const 329) (i32.const 4) (i32.const 341) (i32.const 12)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
        ...
        (i32.store (i32.const 0) (i32.const 358))
          ...
          (drop (call $fd_write
            ...
            (i32.const 1)
            (i32.const 128)))
    (local.set $items (i32.const 260))
    (local.set $rangeOut_ptr (i32.const 362))
      (local.set $rangeOut_len (i32.const 7))
    (local.set $i (f64.const 0))
    (block $break_1
      (loop $loop_1
        (br_if $break_1 (i32.eqz (f64.lt (local.get $i) (i32.const 4))))
        (block $cont_1
          (local.set $rangeOut (i32.add (local.get $rangeOut) (i32.add (i32.load (i32.add (i32.const 260) (i32.shl (local.get $i) (i32.const 2)))) (;? " " ;) (i32.const 0))))
        )
        (local.set $i (f64.add (local.get $i) (f64.const 1)))
        (br $loop_1)
      )
  ...
  (data (i32.const 260) "")
  (data (i32.const 276) "\56\61\6c\75\65\3a\20\7b\7b\2e\7d\7d")
  (data (i32.const 288) "\73\6f\6d\65\20\74\65\78\74")
  (data (i32.const 297) "\35")
  (data (i32.const 298) "\5b\47\6f\20\52\75\73\74\20\43\2b\2b\20\43\23\5d")
  (data (i32.const 314) "\4e\61\6d\65\3a\20\7b\7b\2e\4e\61\6d\65\7d\7d")
  (data (i32.const 329) "\4e\61\6d\65")
  (data (i32.const 333) "\4a\61\6e\65\20\44\6f\65")
  (data (i32.const 341) "\4d\69\63\6b\65\79\20\4d\6f\75\73\65")
  (data (i32.const 353) "\79\65\73\20\0a")
  (data (i32.const 358) "\6e\6f\20\0a")
  (data (i32.const 362) "\52\61\6e\67\65\3a\20")
