(module
  ...
  (func $_start (export "_start")
    ...
    (local.set $argsWithProg (i32.const 261))
    (local.set $argsWithoutProg (i32.const 281))
    (;; string assignment from complex expression not yet supported: arg = argsWithProg[3];)
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $strArrStr (local.get $argsWithProg)) (i32.const 132)))
          ...
          (drop (call $fd_write
            ...
            (i32.const 128)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (call $__i32_to_str (call $strArrStr (local.get $argsWithoutProg)) (i32.const 132)))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (drop (call $fd_write
            (i32.const 1)
  ...
  (data (i32.const 261) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
  (data (i32.const 281) "\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
)